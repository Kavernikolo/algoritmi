...
static int precedes_string(void *s1_p, void *s2_p)
{
    ...
    if ((strcmp(string1_p, string2_p)) <= 0){ return (1); }
...
void test_are_empty_zero_el(void)
{
...
void test_are_empty_one_el(void)
{
...
void test_add_get_three_el(void)
{
...
void test_merge_sort_three_el(void)
{
    int *exp_int[] = {&i1, &i2, &i3};
